    ...
    Command::new("osmquadtree")
        ...
        .subcommand(
            Command::new("count")
                ...
                .arg(Arg::new("PRIMITIVE").short('p').long("primitive").help("reads full primitiveblock data"))
                ...
                .arg(Arg::new("NUMCHAN").short('n').long("numchan").num_args(1).help("uses NUMCHAN parallel threads"))
        ...
        .subcommand(
            Command::new("calcqts")
                ...
                .arg(Arg::new("QT_LEVEL").short('l').long("qt_level").num_args(1).help("maximum qt level, defaults to 18"))
                .arg(Arg::new("QT_BUFFER").short('b').long("qt_buffer").num_args(1).help("qt buffer, defaults to 0.05"))
                .arg(Arg::new("KEEPTEMPS").short('k').long("keeptemps").help("keep temp files"))
                .arg(Arg::new("RAM_GB").short('r').long("ram").num_args(1).help("can make use of RAM_GB gb memory"))
        )
        .subcommand(
        ...
        .subcommand(
            Command::new("calcqts_load_existing")
                ...
                //.arg(Arg::new("COMBINED").short("-c").long("combined").help("writes combined NodeWayNodes file"))
                .arg(Arg::new("NUMCHAN").short('n').long("numchan").num_args(1).help("uses NUMCHAN parallel threads"))
                .arg(Arg::new("STOP_AT").short('s').long("stop_at").num_args(1).help("location of first file block without nodes"))
                .arg(Arg::new("QT_LEVEL").short('l').long("qt_level").num_args(1).help("maximum qt level, defaults to 18"))
                .arg(Arg::new("QT_BUFFER").short('b').long("qt_buffer").num_args(1).help("qt buffer, defaults to 0.05"))
        )
        ...
        .subcommand(
            Command::new("sortblocks")
                ...
                .arg(Arg::new("QT_MAX_LEVEL").short('l').long("qt_max_level").num_args(1).help("maximum qt level, defaults to 17"))
                ...
                .arg(Arg::new("KEEPTEMPS").short('k').long("keeptemps").help("keep temp files"))
                .arg(Arg::new("RAM_GB").short('r').long("ram").num_args(1).help("can make use of RAM_GB gb memory"))
                .arg(Arg::new("BROTLI").short('B').long("brotli").help("use brotli compression"))
                .arg(Arg::new("LZMA").short('L').long("lzma").help("use lzma compression"))
                .arg(Arg::new("UNCOMPRESSED").short('U').long("uncompressed").help("don't use any compression"))
                //.arg(Arg::new("LZ4").short("-Z").long("lz4").help("use lz4 compression"))
                .arg(Arg::new("COMPLEVEL").short('C').long("compression_level").num_args(1).help("compression level"))
        ...
        .subcommand(
            Command::new("update")
                ...
                .arg(Arg::new("INPUT").required(true).help("Sets the input directory to use").value_hint(clap::ValueHint::AnyPath))
                .arg(Arg::new("LIMIT").short('l').long("limit").num_args(1).help("only run LIMIT updates"))
                .arg(Arg::new("NUMCHAN").short('n').long("numchan").num_args(1).help("uses NUMCHAN parallel threads"))
        ...
        .subcommand(
            Command::new("mergechanges_sort_inmem")
                ...
                .arg(Arg::new("FILTEROBJS").short('F').long("filterobjs").help("filter objects within blocks"))
                .arg(Arg::new("TIMESTAMP").short('t').long("timestamp").num_args(1).help("timestamp for data"))
                .arg(Arg::new("NUMCHAN").short('n').long("numchan").num_args(1).help("uses NUMCHAN parallel threads"))
                .arg(Arg::new("RAM_GB").short('r').long("ram").num_args(1).help("can make use of RAM_GB gb memory"))
                .arg(Arg::new("BROTLI").short('B').long("brotli").help("use brotli compression"))
        ...
        .subcommand(
            Command::new("mergechanges_sort")
                ...
                .arg(Arg::new("NUMCHAN").short('n').long("numchan").num_args(1).help("uses NUMCHAN parallel threads"))
                .arg(Arg::new("RAM_GB").short('r').long("ram").num_args(1).help("can make use of RAM_GB gb memory"))
                .arg(Arg::new("SINGLETEMPFILE").short('S').long("single_temp_file").help("write temp data to one file"))
                .arg(Arg::new("BROTLI").short('B').long("brotli").help("use brotli compression"))
                .arg(Arg::new("LZMA").short('L').long("lzma").help("use lzma compression"))
                .arg(Arg::new("UNCOMPRESSED").short('U').long("uncompressed").help("don't use any compression"))
                //.arg(Arg::new("LZ4").short("-Z").long("lz4").help("use lz4 compression"))
        ...
        .subcommand(
            Command::new("mergechanges_sort_from_existing")
                ...
                .arg(Arg::new("ISSPLIT").short('s').long("issplit").help("temp files were split"))
                .arg(Arg::new("NUMCHAN").short('n').long("numchan").num_args(1).help("uses NUMCHAN parallel threads"))
                .arg(Arg::new("BROTLI").short('B').long("brotli").help("use brotli compression"))
                .arg(Arg::new("LZMA").short('L').long("lzma").help("use lzma compression"))
                .arg(Arg::new("UNCOMPRESSED").short('U').long("uncompressed").help("don't use any compression"))
